...
class BadTab extends StatefulWidget {
  BadTab({Key? key, required this.index}) : super(key: key);
  int index;

  @override
  State<BadTab> createState() => _BadTabState();
}

class _BadTabState extends State<BadTab> {
  void initState() {
