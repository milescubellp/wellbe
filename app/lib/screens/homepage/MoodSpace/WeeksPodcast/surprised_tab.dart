...
class SurprisedTab extends StatefulWidget {
  SurprisedTab({Key? key, required this.index}) : super(key: key);
  int index;

  @override
  State<SurprisedTab> createState() => _SurprisedTabState();
}

class _SurprisedTabState extends State<SurprisedTab> {
  void initState() {
