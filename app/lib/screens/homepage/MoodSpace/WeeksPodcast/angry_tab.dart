...
class AngryTab extends StatefulWidget {
  AngryTab({Key? key, required this.index}) : super(key: key);
  int index;

  @override
  State<AngryTab> createState() => _AngryTabState();
}

class _AngryTabState extends State<AngryTab> {
  void initState() {
