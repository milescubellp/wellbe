...
class FearTab extends StatefulWidget {
  FearTab({Key? key, required this.index}) : super(key: key);
  int index;

  @override
  State<FearTab> createState() => _FearTabState();
}

class _FearTabState extends State<FearTab> {
  void initState() {
