...
class HappyThoughtTab extends StatefulWidget {
  const HappyThoughtTab({super.key, required this.index});

  @override
  State<HappyThoughtTab> createState() => _HappyThoughtTabState();
  final int index;
}

class _HappyThoughtTabState extends State<HappyThoughtTab> {
  @override
  void initState() {
