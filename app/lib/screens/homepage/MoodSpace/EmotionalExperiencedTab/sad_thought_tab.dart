...
class SadThoughtTab extends StatefulWidget {
  const SadThoughtTab({super.key, required this.index});

  @override
  State<SadThoughtTab> createState() => _SadThoughtTabState();
  final int index;
}

class _SadThoughtTabState extends State<SadThoughtTab> {
  @override
  void initState() {
