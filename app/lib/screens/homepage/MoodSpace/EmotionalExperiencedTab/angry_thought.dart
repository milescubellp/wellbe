...
class AngryThoughtTab extends StatefulWidget {
  const AngryThoughtTab({super.key, required this.index});

  @override
  State<AngryThoughtTab> createState() => _AngryThoughtTabState();
  final int index;
}

class _AngryThoughtTabState extends State<AngryThoughtTab> {
  @override
  void initState() {
