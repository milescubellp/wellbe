...
class FearThoughtTab extends StatefulWidget {
  const FearThoughtTab({super.key, required this.index});

  @override
  State<FearThoughtTab> createState() => _FearThoughtTabState();
  final int index;
}

class _FearThoughtTabState extends State<FearThoughtTab> {
  @override
  void initState() {
