...
class UserDetailModel {
  ...
  factory UserDetailModel.fromJson(Map<String, dynamic> json) => UserDetailModel(
    ...
    playlist: json["Playlist"] == null ? [] : List<Playlist>.from(json["Playlist"]!.map((x) => Playlist.fromJson(x))),
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "Playlist": playlist == null ? [] : List<dynamic>.from(playlist!.map((x) => x.toJson())),
  };
}
...
class Playlist {
  ...
  factory Playlist.fromJson(Map<String, dynamic> json) => Playlist(
    ...
    playlistVideo: json["PlaylistVideo"] == null ? [] : List<PlaylistVideo>.from(json["PlaylistVideo"]!.map((x) => PlaylistVideo.fromJson(x))),
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "name": name,
    "created": created,
    "PlaylistVideo": playlistVideo == null ? [] : List<dynamic>.from(playlistVideo!.map((x) => x.toJson())),
  };
}
...
class User {
  ...
  factory User.fromJson(Map<String, dynamic> json) => User(
    ...
    created: json["created"],
    story: json["story"] == null ? [] : List<dynamic>.from(json["story"]!.map((x) => x)),
    followersCount: json["followers_count"],
    followingCount: json["following_count"],
    likesCount: json["likes_count"],
    videoCount: json["video_count"],
    profileVisitCount: json["profile_visit_count"],
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "created": created,
    "story": story == null ? [] : List<dynamic>.from(story!.map((x) => x)),
