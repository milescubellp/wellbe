...
@section('title', 'Add podcast Audio')
@section('content')
	...
	<div class="col-md-12 grid-margin">
	  ...
	  <div class="d-flex align-items-end flex-wrap justify-content-between w-100">
		  ...
		  <div class="d-flex">
			...
			<p class="text-primary mb-0 hover-cursor">Add podcast Audio</p>
		  </div>
		</div>
	  </div>
	</div>
	...
	<div class="col-12 grid-margin stretch-card">
	  <div class="card">
		<div class="card-body">
			...
			@endif
			<form role="form" action="{{ asset('admin/add_podcast_audio_action') }}" method="POST" enctype='multipart/form-data'>
			@CSRF
			<div class="row">
                ...
                <input type="text" name="audio" id="audiovalue" value="">
                <div class="form-group col-6">
