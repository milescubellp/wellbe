...
@section('title', 'Add Thought Category')
@section('content')
	...
	<div class="col-md-12 grid-margin">
	  ...
	  <div class="d-flex align-items-end flex-wrap justify-content-between w-100">
		  <div class="me-md-3 me-xl-5">
			<h2>Add Thought Category</h2>
		  </div>
		  <div class="d-flex">
			<i class="mdi mdi-home text-muted hover-cursor"></i>
			<p class="text-muted mb-0 hover-cursor">&nbsp;/&nbsp;Dashboard&nbsp;/&nbsp;</p>
			<p class="text-primary mb-0 hover-cursor">Add Thought Category</p>
		  </div>
		</div>
	  </div>
	</div>
	...
	<div class="col-12 grid-margin stretch-card">
	  <div class="card">
		<div class="card-body">
			...
			@endif
			<form role="form" action="{{ asset('admin/add_thought_category_action') }}" method="POST" enctype='multipart/form-data'>
			@CSRF
			<div class="row">
